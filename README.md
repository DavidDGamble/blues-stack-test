...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create todo-remix-blues-stack-1553
  fly apps create todo-remix-blues-stack-1553-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app todo-remix-blues-stack-1553
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app todo-remix-blues-stack-1553-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'todo-remix-blues-stack-1553-staging' does not match app name in config file 'todo-remix-blues-stack-1553'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name todo-remix-blues-stack-1553-db
  fly postgres attach --app todo-remix-blues-stack-1553 todo-remix-blues-stack-1553-db

  fly postgres create --name todo-remix-blues-stack-1553-staging-db
  fly postgres attach --app todo-remix-blues-stack-1553-staging todo-remix-blues-stack-1553-staging-db
  ```
